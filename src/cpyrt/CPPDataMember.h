#ifndef CPYRT_CPPDATAMEMBER_H
#define CPYRT_CPPDATAMEMBER_H
...
class CPPDataMember {
public:
    void Set(cppjit::interop::TCppScope_t scope, cppjit::interop::TCppScope_t var);
    void Set(cppjit::interop::TCppScope_t scope, const std::string& name, void* address);
...
inline CPPDataMember* CPPDataMember_New(
    cppjit::interop::TCppScope_t scope, cppjit::interop::TCppScope_t var)
{
...
inline CPPDataMember* CPPDataMember_NewConstant(
    cppjit::interop::TCppScope_t scope, const std::string& name, void* address)
{
// Create an initialize a new property descriptor, given the C++ datum.
    CPPDataMember* pyprop =
        (CPPDataMember*)CPPDataMember_Type.tp_new(&CPPDataMember_Type, nullptr, nullptr);
