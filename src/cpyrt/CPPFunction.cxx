...
PyObject* cpyrt::CPPFunction::Call(CPPInstance*& self,
...
// provided, it will be the first argument and may have been updated
    if (IsConstructor(ctxt->fFlags) && result && !cargs.fSelf && \
            cpyrt_PyArgs_GET_SIZE(cargs.fArgs, cargs.fNArgsf) && CPPInstance_Check(cargs.fArgs[0])) {
...
{
    PyObject* cppname = cpyrt_PyText_FromString((GetReturnTypeName() + " (*)").c_str());
...
PyObject* cpyrt::CPPReverseBinary::Call(CPPInstance*& self,
    cpyrt_PyArgs_t args, size_t nargsf, PyObject* kwds, CallContext* ctxt)
{
