...
//- private helpers -----------------------------------------------------------
static inline
void unroll(cpyrt_PyArgs_t packed_args, cpyrt_PyArgs_t unrolled, Py_ssize_t nArgs)
{
...
// the (unrolled) actual arguments
    ((RefExecutor*)this->GetExecutor())->SetAssignable(cpyrt_PyArgs_GET_ITEM(cargs.fArgs, nArgs-1));
...
// unroll any tuples, if present in the arguments
    if (realsize != nArgs-1) {
        cpyrt_PyArgs_t unrolled = (PyObject**)PyMem_Malloc(realsize * sizeof(PyObject*));
