...
class PyCallArgs {
public:
    PyCallArgs(CPPInstance*& self, cpyrt_PyArgs_t args, size_t nargsf, PyObject* kwds)
...
public:
    CPPMethod(cppjit::interop::TCppScope_t scope, cppjit::interop::TCppMethod_t method);
...
public:
    ...
    PyObject* Reflex(cppjit::interop::Reflex::RequestId_t request,
                             cppjit::interop::Reflex::FormatId_t = cppjit::interop::Reflex::OPTIMAL) override;
...
protected:
    ...
    bool ConvertAndSetArgs(cpyrt_PyArgs_t, size_t nargsf, CallContext* ctxt = nullptr);
