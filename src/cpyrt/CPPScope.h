...
typedef std::unordered_map<cppjit::interop::TCppObject_t, PyObject*> CppToPyMap_t;
...
//- creation -----------------------------------------------------------------
inline CPPScope* CPPScopeMeta_New(cppjit::interop::TCppScope_t klass, PyObject* args)
{
