...
static inline cpyrt::CPPInstance* GetCppInstance(
    PyObject* pyobject, interop::TCppScope_t klass = interop::TCppScope_t{}, bool accept_rvalue = false)
{
...
static inline bool CArraySetArg(
    PyObject* pyobject, cpyrt::Parameter& para, char tc, int size, bool check=true)
{
...
// general case of loading a C array pointer (void* + type code) as function argument
    else if (pyobject == cpyrt::gNullPtrObject || pyobject == cpyrt::gDefaultObject)
        para.fValue.fVoidp = nullptr;
    else {
        Py_ssize_t buflen = cpyrt::Utility::GetBuffer(pyobject, tc, size, para.fValue.fVoidp, check);
        if (!buflen) {
...
static inline cpyrt::CPPInstance* ConvertImplicit(interop::TCppScope_t klass,
    PyObject* pyobject, cpyrt::Parameter& para, cpyrt::CallContext* ctxt, bool manage=true)
{
    using namespace cppjit::cpyrt;
...
//----------------------------------------------------------------------------
bool cppjit::cpyrt::Converter::ToMemory(PyObject*, void*, PyObject* /* ctxt */)
{
// could happen if no derived class override
...
{                                                                            \
    return F1((stype)*((type*)address));                                     \
                                                                             ...
                                                                             \
bool cpyrt::name##Converter::ToMemory(                                    \
...
bool cpyrt::name##Converter::SetArg(                                      \
    ...
    if (PyBytes_Check(pyobject)) {
        ...
        if (cpyrt_PyText_GET_SIZE(pyobject) == 1)
            ...
            PyErr_Format(PyExc_ValueError, "%s expected, got str of size " PY_SSIZE_T_FORMAT,
                tname, cpyrt_PyText_GET_SIZE(pyobject));
    } else if (pyobject == cpyrt::gDefaultObject) {
        lchar = (int)'\0';
...
//----------------------------------------------------------------------------
#define CPPJIT_IMPL_BASIC_CONST_CHAR_REFCONVERTER(name, type, ctype, low, high)\
bool cpyrt::Const##name##RefConverter::SetArg(                            \
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)            \
{                                                                            \
...
CPPJIT_IMPL_BASIC_CONVERTER_IB(Long, long, long, c_long, PyLong_FromLong, cpyrt_PyLong_AsStrictLong, 'l')

//----------------------------------------------------------------------------
bool cpyrt::LongRefConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::IntRefConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
bool cpyrt::name##RefConverter::SetArg(                                   \
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)            \
{                                                                            \
/* convert a reference to int to Python through ctypes pointer object */     \
...
CPPJIT_IMPL_BASIC_CONVERTER_NI(
    Bool, bool, long, c_bool, PyBool_FromLong, cpyrt_PyLong_AsBool, 'l')
...
//----------------------------------------------------------------------------
bool cpyrt::WCharConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
bool cpyrt::WCharConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::Char16Converter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
bool cpyrt::Char16Converter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
    if (!PyUnicode_Check(value) || cpyrt_PyUnicode_GET_SIZE(value) != 1) {
        PyErr_SetString(PyExc_ValueError, "single char16_t character expected");
        return false;
...
//----------------------------------------------------------------------------
bool cpyrt::Char32Converter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
bool cpyrt::Char32Converter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
//----------------------------------------------------------------------------
CPPJIT_IMPL_BASIC_CONVERTER_IB(
    Int8,  int8_t,  long, c_int8, PyInt_FromLong, cpyrt_PyLong_AsInt8,  'l')
CPPJIT_IMPL_BASIC_CONVERTER_IB(
    UInt8, uint8_t, long, c_uint8, PyInt_FromLong, cpyrt_PyLong_AsUInt8, 'l')
CPPJIT_IMPL_BASIC_CONVERTER_IB(
    Short, short, long, c_short, PyInt_FromLong, cpyrt_PyLong_AsShort, 'l')
CPPJIT_IMPL_BASIC_CONVERTER_IB(
    UShort, unsigned short, long, c_ushort, PyInt_FromLong, cpyrt_PyLong_AsUShort, 'l')
CPPJIT_IMPL_BASIC_CONVERTER_IB(
    Int, int, long, c_uint, PyInt_FromLong, cpyrt_PyLong_AsStrictInt, 'l')

//----------------------------------------------------------------------------
bool cpyrt::ULongConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::ULongConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
bool cpyrt::UIntConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
CPPJIT_IMPL_BASIC_CONVERTER_NB(
...
cpyrt::ComplexDConverter::ComplexDConverter(bool keepControl) :
    InstanceConverter(interop::GetFullScope("std::complex<double>"), keepControl) {}

// special case for std::complex<double>, maps it to/from Python's complex
bool cpyrt::ComplexDConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::ComplexDConverter::ToMemory(PyObject* value, void* address, PyObject* ctxt)
{
...
//----------------------------------------------------------------------------
bool cpyrt::DoubleRefConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::LLongConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::LLongConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::ULLongConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::ULLongConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::CStringConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
// construct python object from C++ const char* read at <address>
    if (address && *(void**)address) {
        if (fMaxSize != std::string::npos)       // need to prevent reading beyond boundary
            return cpyrt_PyText_FromStringAndSize(*(char**)address, (Py_ssize_t)fMaxSize);

        if (*(void**)address == (void*)fBuffer.data())     // if we're buffering, we know the size
            return cpyrt_PyText_FromStringAndSize((char*)fBuffer.data(), fBuffer.size());
...
bool cpyrt::CStringConverter::ToMemory(PyObject* value, void* address, PyObject* ctxt)
{
...
//----------------------------------------------------------------------------
bool cpyrt::WCStringConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
// construct a new string and copy it in new memory
...
bool cpyrt::WCStringConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
// verify (too long string will cause truncation, no crash)
    ...
    if (fMaxSize != std::wstring::npos)
        res = cpyrt_PyUnicode_AsWideChar(value, *(wchar_t**)address, (Py_ssize_t)fMaxSize);
    else
    // coverity[secure_coding] - can't help it, it's intentional.
...
/* empty string in case there's no valid address */                          \
    ...
    return decode((const char*)&w, 0, nullptr, nullptr);                     \
                                                                             ...
                                                                             \
bool cpyrt::name##Converter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)\
{                                                                            \
...
CPYRT_WIDESTRING_CONVERTER(CString16, char16_t, PyUnicode_AsUTF16String, PyUnicode_DecodeUTF16, u'\0')
CPYRT_WIDESTRING_CONVERTER(CString32, char32_t, PyUnicode_AsUTF32String, PyUnicode_DecodeUTF32, U'\0')

//----------------------------------------------------------------------------
bool cpyrt::NonConstCStringConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
bool cpyrt::VoidArrayConverter::GetAddressSpecialCase(PyObject* pyobject, void*& address)
{
...
//----------------------------------------------------------------------------
bool cpyrt::VoidArrayConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
bool cpyrt::VoidArrayConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
// just convert pointer if it is a C++ object
...
public:
    StdSpanConverter(std::string const &typeName, interop::TCppScope_t klass, bool keepControl = false)
...
//----------------------------------------------------------------------------
bool cpyrt::StdSpanConverter::SetArg(PyObject *pyobject, Parameter &para, CallContext *ctxt)
{
...
#define CPPJIT_IMPL_ARRAY_CONVERTER(name, ctype, type, code, suffix)            \
  ...
  bool cpyrt::name##ArrayConverter::SetArg(                                 \
    ...
    if (!convOk && fShape.ndim() == 2) {                                       \
      if (Py_TYPE(pyobject) == GetCTypesPtrType(ct_##ctype)) {                 \
        para.fValue.fVoidp =                                                   \
            (void *)((cpyrt_tagCDataObject *)pyobject)->b_ptr;              \
        para.fTypeCode = 'p';                                                  \
        convOk = true;                                                         \
  ...
  PyObject *cpyrt::name##ArrayConverter::FromMemory(void *address) {        \
    ...
    return CreateLowLevelView##suffix(*(type **)address, fShape);              \
                                                                               ...
                                                                               \
  bool cpyrt::name##ArrayConverter::ToMemory(                               \
      PyObject *value, void *address, PyObject *ctxt) {                        \
...
//----------------------------------------------------------------------------
bool cpyrt::CStringArrayConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::NullptrConverter::SetArg(PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
//----------------------------------------------------------------------------
template<typename T>
static inline bool cpyrt_PyUnicodeAsBytes2Buffer(PyObject* pyobject, T& buffer) {
...
{                                                                            \
    ...
    auto* empty = new type();                                                \
    return BindCppObjectNoCast(interop::TCppObject_t((void*)empty), fClass, CPPInstance::kIsOwner);\
}                                                                            \
                                                                             \
bool cpyrt::name##Converter::ToMemory(                                    \
    PyObject* value, void* address, PyObject* ctxt)                          \
...
bool cpyrt::STLWStringConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::STLWStringConverter::ToMemory(PyObject* value, void* address, PyObject* ctxt)
{
...
cpyrt::STLStringViewConverter::STLStringViewConverter(bool keepControl) :
    InstanceConverter(interop::GetFullScope("std::string_view"), keepControl) {}

bool cpyrt::STLStringViewConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
// the caller to ensure any external changes propagate correctly
    if (CPPInstance_Check(pyobject)) {
        static interop::TCppScope_t sStringID = interop::GetUnderlyingScope(interop::GetFullScope("std::string"));
...
bool cpyrt::STLStringViewConverter::ToMemory(
    PyObject* value, void* address, PyObject* ctxt)
{
...
bool cpyrt::STLStringMoveConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::InstancePtrConverter<ISCONST>::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
// convert <pyobject> to C++ instance*, set arg for call
    CPPInstance* pyobj = GetCppInstance(pyobject, ISCONST ? fClass : interop::TCppScope_t{});
    if (!pyobj) {
        if (GetAddressSpecialCase(pyobject, para.fValue.fVoidp)) {
   ...
   // not a cppjit object (TODO: handle SWIG etc.)
    ...
    if (pyobj->IsSmart() && IsConstructor(ctxt->fFlags) && interop::IsSmartPtr(ctxt->fCurScope))
        return false;
...
//----------------------------------------------------------------------------
template <bool ISCONST>
bool cpyrt::InstancePtrConverter<ISCONST>::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
// convert <value> to C++ instance, write it at <address>
    CPPInstance* pyobj = GetCppInstance(value, ISCONST ? fClass : interop::TCppScope_t{});
    if (!pyobj) {
        void* ptr = nullptr;
        if (GetAddressSpecialCase(value, ptr)) {
...
//----------------------------------------------------------------------------
bool cpyrt::InstanceConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
// convert <pyobject> to C++ instance, set arg for call
...
//----------------------------------------------------------------------------
bool cpyrt::InstanceConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
//----------------------------------------------------------------------------
bool cpyrt::InstanceRefConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
// convert <pyobject> to C++ instance&, set arg for call
    CPPInstance* pyobj = GetCppInstance(pyobject, fIsConst ? fClass : interop::TCppScope_t{});
    if (pyobj) {
...
{
    return BindCppObjectNoCast((interop::TCppObject_t)address, fClass, CPPInstance::kIsReference);
}

//----------------------------------------------------------------------------
bool cpyrt::InstanceMoveConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
// convert <pyobject> to C++ instance&&, set arg for call
...
//----------------------------------------------------------------------------
template <bool ISREFERENCE>
PyObject* cpyrt::InstancePtrPtrConverter<ISREFERENCE>::FromMemory(void* address)
{
// construct python object from C++ instance* read at <address>
...
//----------------------------------------------------------------------------
bool cpyrt::InstanceArrayConverter::SetArg(
...
//----------------------------------------------------------------------------
bool cpyrt::InstanceArrayConverter::ToMemory(
    PyObject* /* value */, void* /* address */, PyObject* /* ctxt */)
{
...
bool cpyrt::STLIteratorConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
    if (!CPPInstance_Check(pyobject))
        return false;
...
//----------------------------------------------------------------------------
bool cpyrt::VoidPtrRefConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
//----------------------------------------------------------------------------
cpyrt::VoidPtrPtrConverter::VoidPtrPtrConverter(cdims_t dims, const std::string &failureMsg) :
        fShape(dims), fFailureMsg (failureMsg) {
    fIsFixed = dims ? fShape[0] != UNKNOWN_SIZE : false;
}

//----------------------------------------------------------------------------
bool cpyrt::VoidPtrPtrConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
// convert <pyobject> to C++ void**, set arg for call
    CPPInstance* pyobj = GetCppInstance(pyobject);
...
//----------------------------------------------------------------------------
bool cpyrt::PyObjectConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* /* ctxt */)
{
...
bool cpyrt::PyObjectConverter::ToMemory(PyObject* value, void* address, PyObject* /* ctxt */)
{
...
// function pointer. The former is direct, the latter involves a JIT-ed wrapper.
    ...
    // get the actual underlying template matching the signature
        ...
        interop::TCppMethod_t cppmeth = interop::GetMethodTemplate(scope, fullname, true_signature);
        if (cppmeth) {
     ...
     // create wrapper if no re-use possible
       ...
       // build wrapper function code
        ...
        // TODO: is there no easier way?
            static interop::TCppScope_t scope = interop::GetScope("__cppjit_internal");
...
bool cpyrt::FunctionPointerConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::FunctionPointerConverter::ToMemory(
...
bool cpyrt::StdFunctionConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
bool cpyrt::StdFunctionConverter::ToMemory(PyObject* value, void* address, PyObject* ctxt)
{
...
bool cpyrt::SmartPtrConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
// unique_ptr<Base> and must not pass where a unique_ptr<Derived> is expected.
    if (pyobj->IsSmart() && interop::IsSubclass(pyobj->GetSmartUnderlyingType(), fUnderlyingType)) {
...
bool cpyrt::SmartPtrConverter::ToMemory(PyObject* value, void* address, PyObject*)
{
...
cpyrt::InitializerListConverter::InitializerListConverter(interop::TCppScope_t klass, std::string const &value_type)
...
bool cpyrt::InitializerListConverter::SetArg(
    PyObject* pyobject, Parameter& para, CallContext* ctxt)
{
...
// (likely explicitly created std::initializer_list, go through an instance converter
    if (!PySequence_Check(pyobject) || cpyrt_PyText_Check(pyobject) || PyBytes_Check(pyobject)
        )
        return false;
...
//----------------------------------------------------------------------------
bool cpyrt::NotImplementedConverter::SetArg(PyObject*, Parameter&, CallContext*)
{
...
static inline cppjit::cpyrt::Converter* selectInstanceCnv(interop::TCppScope_t klass,
        const std::string& cpd, cpyrt::cdims_t dims, bool isConst, bool control)
{
    using namespace cppjit::cpyrt;
...
//- factories ----------------------------------------------------------------
CPYRT_EXPORT
cppjit::cpyrt::Converter* cppjit::cpyrt::CreateConverter(const std::string& fullType, cdims_t dims)
{
...
//-- special case: initializer list
    ...
    // get the type of the list and create a converter (TODO: get hold of value_type?)
        ...
        return new InitializerListConverter(interop::GetScope(realType), value_type);
    }
...
//-- special case: std::function
    ...
    // get actual converter for normal passing
        Converter* cnv = selectInstanceCnv(
            interop::GetScope(realType), cpd, dims, isConst, control);
...
CPYRT_EXPORT
cppjit::cpyrt::Converter* cppjit::cpyrt::CreateConverter(interop::TCppType_t type, cdims_t dims)
{
// The matching of the fulltype to a converter factory goes through up to five levels:
//   1) full, exact match
//   2) match of decorated, unqualified type
...
//-- nothing? ok, collect information about the type and possible qualifiers/decorators
    ...
    interop::TCppType_t realType = interop::ResolveType(interop::GetRealType(type));
...
//-- special case: initializer list
    ...
    // get the type of the list and create a converter (TODO: get hold of value_type?)
        ...
        if (cnv || use_byte_cnv)
            return new InitializerListConverter(interop::GetScopeFromType(realType), value_type);
    }
...
//-- special case: std::function
    ...
    // get actual converter for normal passing
        Converter* cnv = selectInstanceCnv(
            interop::GetScopeFromType(realType), cpd, dims, isConst, control);
...
// converters for known C++ classes and default (void*)
    ...
    } else if ((realTypeStr != "std::byte") && (klass || (klass = interop::GetFullScope(realTypeStr)))) {
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
bool cpyrt::RegisterConverterAlias(const std::string& name, const std::string& target)
{
