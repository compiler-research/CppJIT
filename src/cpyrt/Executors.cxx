...
static inline rtype GILCall##tcode(                                          \
    interop::TCppMethod_t method, interop::TCppObject_t self, cpyrt::CallContext* ctxt)\
{                                                                            \
    if (!ReleasesGIL(ctxt))                                                  \
        return interop::Call##tcode(method, self, ctxt->GetEncodedSize(), ctxt->GetArgs());\
    GILControl gc{};                                                         \
    return interop::Call##tcode(method, self, ctxt->GetEncodedSize(), ctxt->GetArgs());\
}
#else
...
static inline interop::TCppObject_t GILCallO(interop::TCppMethod_t method,
    interop::TCppObject_t self, cpyrt::CallContext* ctxt, interop::TCppScope_t klass)
{
    interop::TCppType_t klass_ty = interop::GetTypeFromScope(klass);
#ifdef WITH_THREAD
    if (!ReleasesGIL(ctxt))
#endif
        return interop::CallO(method, self, ctxt->GetEncodedSize(), ctxt->GetArgs(), klass_ty);
#ifdef WITH_THREAD
    GILControl gc{};
    return interop::CallO(method, self, ctxt->GetEncodedSize(), ctxt->GetArgs(), klass_ty);
#endif
...
static inline interop::TCppObject_t GILCallConstructor(
    interop::TCppMethod_t method, interop::TCppScope_t klass, cpyrt::CallContext* ctxt)
{
#ifdef WITH_THREAD
    if (!ReleasesGIL(ctxt))
#endif
        return interop::CallConstructor(method, klass, ctxt->GetEncodedSize(), ctxt->GetArgs());
#ifdef WITH_THREAD
    GILControl gc{};
    return interop::CallConstructor(method, klass, ctxt->GetEncodedSize(), ctxt->GetArgs());
#endif
...
// python chars are range(256)
    ...
    int c = (int)cl;
    if (c < 0) return cpyrt_PyText_FromFormat("%c", 256 - std::abs(c));
...
cpyrt::Executor::~Executor()
{
    /* empty */
}

//- executors for built-ins --------------------------------------------------
PyObject* cpyrt::BoolExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::BoolConstRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python bool return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CharExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CharConstRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
// with the single char
...
//----------------------------------------------------------------------------
PyObject* cpyrt::UCharExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::UCharConstRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::WCharExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, args>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::Char16Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, args>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::Char32Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, args>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::IntExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::Int8Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python int return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::UInt8Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python int return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ShortExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python int return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::LongExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ULongExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::LongLongExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ULongLongExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::FloatExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::DoubleExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python float return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::LongDoubleExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python float return value
...
PyObject* cpyrt::name##RefExecutor::Execute(                              \
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt) \
{                                                                            \
...
CPPJIT_IMPL_REFEXEC(ComplexD, std::complex<double>,
    std::complex<double>, PyComplex_FromComplex<double>, PyComplex_AsComplex<double>)


//----------------------------------------------------------------------------
PyObject* cpyrt::STLStringRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, return python string return value
    static interop::TCppScope_t sSTLStringScope = interop::GetFullScope("std::string");
    ...
    *result = std::string(
        cpyrt_PyText_AsString(fAssignable), cpyrt_PyText_GET_SIZE(fAssignable));
...
//----------------------------------------------------------------------------
PyObject* cpyrt::VoidExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CStringExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CStringRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
    char** result = (char**)GILCallR(method, self, ctxt);
...
//----------------------------------------------------------------------------
PyObject* cpyrt::WCStringExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CString16Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python unicode return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CString32Executor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python unicode return value
...
PyObject* cpyrt::VoidArrayExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python long return value
...
PyObject* cpyrt::name##ArrayExecutor::Execute(                            \
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt) \
{                                                                            \
...
PyObject* cpyrt::Complex##code##Executor::Execute(                        \
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt) \
{                                                                            \
    static interop::TCppScope_t scopeid = interop::GetScope("std::complex<"#type">");\
...
//----------------------------------------------------------------------------
PyObject* cpyrt::STLStringExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::STLWStringExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python string return value
    static interop::TCppScope_t sSTLWStringScope = interop::GetFullScope("std::wstring");
    ...
    delete result; // interop::CallO allocates and constructs a string, so it must be properly destroyed

    return pyresult;
}

//----------------------------------------------------------------------------
PyObject* cpyrt::InstancePtrExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
static inline PyObject* SetInstanceCheckError(PyObject* pyobj) {
    ...
    if (pystr) {
        PyErr_Format(PyExc_TypeError,
           "C++ object expected, got %s", cpyrt_PyText_AsString(pystr));
        Py_DECREF(pystr);
    } else
...
PyObject* cpyrt::InstancePtrPtrExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstancePtrRefExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
// execute <method> with argument <self, ctxt>, construct python C++ proxy object
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceArrayExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ConstructorExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t klass, CallContext* ctxt)
{
...
// CPPConstructor for the actual build of the PyObject)
    return (PyObject*)GILCallConstructor(method, interop::TCppScope_t(klass.data), ctxt).data;
}

//----------------------------------------------------------------------------
PyObject* cpyrt::PyObjectExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//----------------------------------------------------------------------------
PyObject* cpyrt::FunctionPointerExecutor::Execute(
    interop::TCppMethod_t method, interop::TCppObject_t self, CallContext* ctxt)
{
...
//- factories ----------------------------------------------------------------
cpyrt::Executor* cpyrt::CreateExecutor(const std::string& fullType, cdims_t dims)
{
...
//-- nothing? ok, collect information about the type and possible qualifiers/decorators
    ...
    interop::TCppType_t realType = interop::IsFunctionPointerType(resolvedType) ? resolvedType : interop::GetRealType(resolvedType);
    std::string realTypeStr = interop::IsFunctionPointerType(resolvedType) ? resolvedTypeStr : interop::GetTypeAsString(realType);
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
bool cpyrt::RegisterExecutorAlias(const std::string& name, const std::string& target)
{
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
void* cpyrt::CallVoidP(interop::TCppMethod_t meth, interop::TCppObject_t obj, CallContext* ctxt)
{
