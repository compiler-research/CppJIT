...
//----------------------------------------------------------------------------
std::string cpyrt::TypeManip::remove_const(const std::string& cppname)
{
...
//----------------------------------------------------------------------------
std::string cpyrt::TypeManip::clean_type(
...
//----------------------------------------------------------------------------
std::string cpyrt::TypeManip::template_base(const std::string& cppname)
{
...
//----------------------------------------------------------------------------
std::string cpyrt::TypeManip::compound(const std::string& name)
{
...
//----------------------------------------------------------------------------
void cpyrt::TypeManip::cppscope_to_pyscope(std::string& cppscope)
{
...
//----------------------------------------------------------------------------
void cpyrt::TypeManip::cppscope_to_legalname(std::string& cppscope)
{
...
//----------------------------------------------------------------------------
std::string cpyrt::TypeManip::extract_namespace(const std::string& name)
{
...
//----------------------------------------------------------------------------
std::vector<std::string> cpyrt::TypeManip::extract_arg_types(const std::string& sig)
{
...
//----------------------------------------------------------------------------
Py_ssize_t cpyrt::TypeManip::array_size(const std::string& name)
{
