...
// name to opaque C++ scope representation -----------------------------------
    ...
    bool AppendTypesSlow(const std::string &name,
                            std::vector<Cpp::TemplateArgInfo>& types, cppjit::interop::TCppScope_t parent = nullptr);
    CPPJIT_IMPORT
...
// Templated method/function reflection information ------------------------------------
    ...
    CPPJIT_IMPORT
    void GetClassOperators(cppjit::interop::TCppScope_t klass, const std::string& opname,
