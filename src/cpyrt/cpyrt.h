...
static inline const char* cpyrt_PyText_AsStringAndSize(PyObject* pystr, Py_ssize_t* size)
{
...
static inline PyObject* cpyrt_PyArgs_GET_ITEM(cpyrt_PyArgs_t args, Py_ssize_t i) {
    return args[i];
}
static inline PyObject* cpyrt_PyArgs_SET_ITEM(cpyrt_PyArgs_t args, Py_ssize_t i, PyObject* item) {
...
inline PyObject* cpyrt_tp_call(
        PyObject* cb, cpyrt_PyArgs_t args, size_t nargsf, PyObject* kwds) {
