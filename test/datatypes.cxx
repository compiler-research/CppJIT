...
void CppjitTestData::set_pod_void_ptrptr_in(void** pp)        { m_pod = **((CppjitTestPod**)pp); }
void CppjitTestData::set_pod_ptrptr_out(CppjitTestPod** ppp) { delete *ppp; *ppp = new CppjitTestPod(m_pod); }
void CppjitTestData::set_pod_void_ptrptr_out(void** pp)       { delete *((CppjitTestPod**)pp);
...
void CppjitTestData::set_ullong_cr(const unsigned long long& ull) { m_ullong   = ull; }
...
const wchar_t*  CppjitTestData::get_valid_wstring(const wchar_t* in) { return in; }
const wchar_t*  CppjitTestData::get_invalid_wstring() { return (const wchar_t*)0; }
const char16_t* CppjitTestData::get_valid_string16(const char16_t* in) { return in; }
const char16_t* CppjitTestData::get_invalid_string16() { return (const char16_t*)0; }
const char32_t* CppjitTestData::get_valid_string32(const char32_t* in) { return in; }
const char32_t* CppjitTestData::get_invalid_string32() { return (const char32_t*)0; }
