...
class TestADVANCEDCPP:
    ...
    def test04_template_types(self):
        ...
        assert gbl.a_ns.T4("a_ns::T4<T3<int,double> >") is gbl.a_ns.T4(
            gbl.a_ns.T4(gbl.T3(int, "double"))
        )
    ...
    def test09_opaque_pointer_passing(self):
        ...
        # assert o == cppjit.bind_object(cobj, "some_concrete_class")
        assert cppjit.addressof(o) == cppjit.addressof(
            cppjit.bind_object(addr, some_concrete_class)
        )
    ...
    def test21_access_to_global_variables(self):
        ...
        assert cppjit.gbl.my_global_double == 12.0
        ...
        assert cppjit.gbl.my_global_ptr[0] == 1234.0
